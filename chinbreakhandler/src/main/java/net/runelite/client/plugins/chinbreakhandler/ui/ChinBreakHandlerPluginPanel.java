...
import static net.runelite.client.plugins.chinbreakhandler.ChinBreakHandlerPlugin.isNumeric;
import static net.runelite.client.plugins.chinbreakhandler.ChinBreakHandlerPlugin.sanitizedName;
import static net.runelite.client.plugins.chinbreakhandler.ui.ChinBreakHandlerPanel.BACKGROUND_COLOR;
import static net.runelite.client.plugins.chinbreakhandler.ui.ChinBreakHandlerPanel.NORMAL_FONT;
import static net.runelite.client.plugins.chinbreakhandler.ui.ChinBreakHandlerPanel.PANEL_BACKGROUND_COLOR;
import static net.runelite.client.plugins.chinbreakhandler.ui.ChinBreakHandlerPanel.SMALL_FONT;
import net.runelite.client.plugins.chinbreakhandler.ui.utils.JMultilineLabel;
import net.runelite.client.plugins.chinbreakhandler.ui.utils.OnOffToggleButton;
import net.runelite.client.plugins.chinbreakhandler.ui.utils.UnitFormatterFactory;
