...
@Slf4j
@Singleton
class MotherloadMineOverlay extends OverlayPanel
{
    ...
    @Inject
    private MotherloadMineOverlay(final Client client, final MotherloadMinePlugin plugin, final MotherloadMineConfig config)
    {
        super(plugin);
    ...
    public Dimension render(Graphics2D graphics)
    {
        ...
        tableComponent.addRow("Deposit count:", String.valueOf(plugin.depositCount));
        tableComponent.addRow("Start Mining (at mining area)?:", String.valueOf(plugin.startMining));
