package net.runelite.client.plugins.pvphelper.ScriptCommand;
...
import net.runelite.client.plugins.pvphelper.PvPHelperConfig;
import net.runelite.client.plugins.pvphelper.PvPHelperOverlay;
import net.runelite.client.plugins.pvphelper.PvPHelperPlugin;

import javax.swing.plaf.basic.BasicListUI;
import java.awt.*;
import java.awt.event.MouseEvent;

import static net.runelite.client.plugins.pvphelper.PvPHelperHotkeyListener.getTag;

public interface ScriptCommand
{
	void execute(Client client, PvPHelperConfig config, PvPHelperPlugin plugin, PvPHelperOverlay overlay, ConfigManager configManager);

	default void clickPrayer(WidgetInfo widgetInfo, Client client, PvPHelperPlugin plugin)
	{
		try
		{
	...
	default void castSpell(WidgetInfo widgetInfo, Client client, PvPHelperPlugin plugin)
	{
		try
		{
	...
	default void clickSpell(WidgetInfo widgetInfo, Client client, PvPHelperPlugin plugin)
	{
		try
		{
			Widget spell_widget = client.getWidget(widgetInfo);
...
{
	public void execute(Client client, PvPHelperConfig config, PvPHelperPlugin plugin, PvPHelperOverlay overlay, ConfigManager configManager)
	{
...
class DoubleSpecCommand implements ScriptCommand
{
	public void execute(Client client, PvPHelperConfig config, PvPHelperPlugin plugin, PvPHelperOverlay overlay, ConfigManager configManager)
	{
		try
		{
			...
			Thread.sleep(plugin.sleepDelay());
