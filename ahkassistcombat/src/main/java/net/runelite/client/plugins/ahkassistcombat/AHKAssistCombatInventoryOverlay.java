...
@Singleton
class AHKAssistCombatInventoryOverlay extends WidgetItemOverlay {
	...
	@Inject
	private AHKAssistCombatInventoryOverlay(final ItemManager itemManager, final AHKAssistCombatPlugin plugin, final AHKAssistCombatConfig config, Client client) {
