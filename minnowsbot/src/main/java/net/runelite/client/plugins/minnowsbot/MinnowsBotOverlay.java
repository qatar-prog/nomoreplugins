...
@Slf4j
@Singleton
class MinnowsBotOverlay extends OverlayPanel
{
    private final Client client;
    private final MinnowsBotPlugin plugin;
    private final MinnowsBotConfig config;

    String timeFormat;

    @Inject
    private MinnowsBotOverlay(final Client client, final MinnowsBotPlugin plugin, final MinnowsBotConfig config)
    {
        super(plugin);
